    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('organization_logo', models.ImageField(blank=True, default='org_logo/org-logo.png', null=True, upload_to='images/company-logo/')),
                ('tc', models.BooleanField()),
                ('is_company', models.BooleanField(default=False)),
                ('country', models.CharField(max_length=100)),
                ('zip_code', models.CharField(max_length=50)),
                ('company_phone_number', models.IntegerField(unique=True)),
                ('invited_code', models.IntegerField(blank=True, null=True)),
                ('premiumUser', models.BooleanField(blank=True, default=False, null=True)),
